...
def main(argv):
    ...
    parser.add_argument(
        ...
        dest="del_time",
        type=str,
        help="delete individual run-time files (but save summary)",
        default="True",
    )
    parser.add_argument(
        "--del-oldCV",
        dest="del_oldCV",
        type=str,
        help="delete any of the older versions of CV training and testing datasets not overwritten (preserves final training and testing datasets)",
        default="True",
    )
