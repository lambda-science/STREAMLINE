...
def job(experiment_path, data_path):
    ...
    if os.path.exists(experiment_path + "/DatasetComparisons"):
        ...
        copy_tree(
            experiment_path + "/DatasetComparisons",
            experiment_path + "/KeyFileCopy" + "/DatasetComparisons",
        )
    ...
    for datasetFilename in glob.glob(data_path + "/*"):
        ...
        if not os.path.exists(experiment_path + "/KeyFileCopy" + "/" + dataset_name):
            ...
            copy_tree(
                experiment_path + "/" + dataset_name + "/model_evaluation/",
                experiment_path
                + "/KeyFileCopy"
                + "/"
                + dataset_name
    ...
    # Copy metafile
    shutil.copy(
        experiment_path + "/metadata.csv",
        experiment_path + "/KeyFileCopy" + "/metadata.csv",
    )
